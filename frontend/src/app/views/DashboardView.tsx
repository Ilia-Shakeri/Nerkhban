...
import { BellPlus, ArrowUpRight, ArrowDownRight, DollarSign, Coins, CircleDollarSign, Gem } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
        {ASSETS.map((asset, idx) => (
          ...
          >
            <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-none dark:hover:border-[#D4AF37]/30">
